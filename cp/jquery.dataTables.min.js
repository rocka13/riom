...
e=a.aoPreSearchCols,f=function(a){d.sSearch=a.sSearch;d.bRegex=a.bRegex;d.bSmart=a.bSmart;d.bCaseInsensitive=a.bCaseInsensitive};Ia(a);if("ssp"!=y(a)){wb(a,b.sSearch,c,b.bEscapeRegex!==k?!b.bEscapeRegex:b.bRegex,b.bSmart,b.bCaseInsensitive);f(b);for(b=0;b<e.length;b++)xb(a,e[b].sSearch,b,e[b].bEscapeRegex!==k?!e[b].bEscapeRegex:e[b].bRegex,e[b].bSmart,e[b].bCaseInsensitive);yb(a)}else f(b);a.bFiltered=!0;w(a,null,"Buscar",[a])}function yb(a){for(var b=m.ext.search,c=a.aiDisplay,d,e,f=0,g=b.length;f<
...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,
//numero de inicio de filtro
iDisplayLength:7

,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",
//siguiente anterior
sNext:"Siguiente",sPrevious:"Anterior"}

,sEmptyTable:"datos no validos en la tabla",sInfo:
//totales de busqueda
"Mostrando (_START_ - _END_) de _TOTAL_ Registros"


,sInfoEmpty:"Mostrando 0 - 0  de 0 Registros",sInfoFiltered:"(busqueda de _MAX_  Registros)",
sInfoPostFix:"",sDecimal:"",sThousands:","
//filtro de menu 
,sLengthMenu:"<bottom class='btn btn-default'><span class='glyphicon-filter glyphicon text-info'></span></bottom> _MENU_ ",


sLoadingRecords:"Cargando...",sProcessing:"Procesando..."
//label buscar
,sSearch:"<bottom class='btn btn-default'><span class='glyphicon-search glyphicon text-warning'></span></bottom> "

,sSearchPlaceholder:"Busqueda de Registros"
,sUrl:"",sZeroRecords:"NO se ha encontrado Ningun registro con estos caracteres"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
...
"asc"?d.sSortAsc:h[e]=="desc"?d.sSortDesc:c.sSortingClass)}})},jqueryui:function(a,b,c,d){h("<div/>").addClass(d.sSortJUIWrapper).append(b.contents()).append(h("<span/>").addClass(d.sSortIcon+" "+c.sSortingClassJUI)).appendTo(b);h(a.nTable).on("order.dt.DT",function(e,f,g,h){if(a===f){e=c.idx;b.removeClass(d.sSortAsc+" "+d.sSortDesc).addClass(h[e]=="desc"?d.sSortAsc:h[e]=="asc"?d.sSortDesc:c.sSortingClass);b.find("span."+d.sSortIcon).removeClass(d.sSortJUIAsc+" "+d.sSortJUIDesc+" "+d.sSortJUI+" "+
