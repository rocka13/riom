$(document).ready(function (){
 ...
 $("#examen").change(function(){
       ...
       $("#valor").html("<p class='loading'><img src='../loading.gif'/><br>Cargando..</p>");
    ...
    $.ajax({
...

           {
               ...
               $("#valor").html(data); // Mostrar la respuestas del script PHP.
...
$("#precio, #cantidad ").change(function(){
       ...
       $("#total").html("<p class='loading'><img src='../loading.gif'/><br>Cargando..</p>");
