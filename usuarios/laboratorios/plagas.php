<?php
  ...
  $aColumns = array( 'id_paciente','nom_2', 'ape_1', 'ape_2','id_cita','ff' );

  /* Columna indexada (Mejora el desempeño de la cardinalidad de la tabla ) */
  $sIndexColumn = "id_paciente";
	
  // DB table to use
  $sTable = 'paciente,cita';
 ...
 */
  ...
  */
  $sWhere = 'WHERE paciente.id_paciente=cita.cita_paciente';
  if( $_GET['sSearch'] != '' ) {
    $sWhere = "WHERE (";
