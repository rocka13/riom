...
$sql_borrar = "UPDATE cita SET factura=0 WHERE id_cita=$antigua";
$borrar = $enlace->query($sql_borrar);

$sql_cambiar = "UPDATE cita SET factura=$factura WHERE id_cita=$nueva";
